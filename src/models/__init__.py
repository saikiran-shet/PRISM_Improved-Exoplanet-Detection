...
def build_prism(latent_dim=64, seq_len=1024, dropout_p=0.3):
    """
    Instantiates the full PRISM model — all four components together.
    Returns them as a dict for easy access in the training loop.
    """
    ...
    classifier         = PRISMClassifier(latent_dim=latent_dim, dropout_p=dropout_p)
